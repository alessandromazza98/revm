...
## [0.5.1](https://github.com/alessandromazza98/revm/compare/revme-v0.5.0...revme-v0.5.1) - 2024-06-10

### Other
- skip tests with storage check and return status ([#1452](https://github.com/alessandromazza98/revm/pull/1452))
