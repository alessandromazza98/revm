...
## [11.0.0](https://github.com/alessandromazza98/revm/compare/revm-v10.0.0...revm-v11.0.0) - 2024-07-03

### Added
- add bytecode_address from CallInputs to Contract during construction. ([#1568](https://github.com/alessandromazza98/revm/pull/1568))
- *(Prague)* Add EIP-7702 ([#1565](https://github.com/alessandromazza98/revm/pull/1565))
- *(EOF)* disallow ExtDelegateCall to legacy bytecode ([#1572](https://github.com/alessandromazza98/revm/pull/1572))
- *(EOF)* Add target address expansion checks ([#1570](https://github.com/alessandromazza98/revm/pull/1570))

### Other
- Use HandleOrRuntime to allow alloydb/ethersdb to hold a custom runtime ([#1576](https://github.com/alessandromazza98/revm/pull/1576))
- store tokio::runtime::Handle in ethers/alloyDB ([#1557](https://github.com/alessandromazza98/revm/pull/1557))
- use const blocks ([#1522](https://github.com/alessandromazza98/revm/pull/1522))
- fix compile for alloydb ([#1559](https://github.com/alessandromazza98/revm/pull/1559))
- replace AccessList with alloy version ([#1552](https://github.com/alessandromazza98/revm/pull/1552))
- replace U256 with u64 in BLOCKHASH ([#1505](https://github.com/alessandromazza98/revm/pull/1505))
