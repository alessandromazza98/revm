...
## [14.2.0](https://github.com/alessandromazza98/revm/compare/op-revm-v14.1.0...op-revm-v14.2.0) - 2025-12-29

### Added

- BAL EIP-7928 ([#3070](https://github.com/alessandromazza98/revm/pull/3070))
- early return if the l1 fee scalar is zero ([#3213](https://github.com/alessandromazza98/revm/pull/3213))
- Restrict Database::Error. JournaledAccountTr ([#3199](https://github.com/alessandromazza98/revm/pull/3199))

### Other

- Remove redundant tx fetch in Optimism handler gas accounting ([#3220](https://github.com/alessandromazza98/revm/pull/3220))
