...
## [9.1.0](https://github.com/alessandromazza98/revm/compare/op-revm-v9.0.1...op-revm-v9.1.0) - 2025-08-21

### Added

- *(fusaka)* Add PrecompileId ([#2904](https://github.com/alessandromazza98/revm/pull/2904))

### Fixed

- *(handler)* correct transaction ID decrement logic ([#2892](https://github.com/alessandromazza98/revm/pull/2892))
