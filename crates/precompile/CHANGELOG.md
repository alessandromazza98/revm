...
## [31.1.0](https://github.com/alessandromazza98/revm/compare/revm-precompile-v31.0.0...revm-precompile-v31.1.0) - 2025-12-29

### Added

- rm gmp use-system-libs ([#3253](https://github.com/alessandromazza98/revm/pull/3253))
- dynamically link gmp ([#3250](https://github.com/alessandromazza98/revm/pull/3250))

### Other

- optimize vector initialization using size hints ([#3200](https://github.com/alessandromazza98/revm/pull/3200))
- optimize precompile `extend()` ([#3192](https://github.com/alessandromazza98/revm/pull/3192))
