...
## [19.0.0](https://github.com/alessandromazza98/revm/compare/revm-precompile-v18.0.0...revm-precompile-v19.0.0) - 2025-04-09

### Added

- Add arkworks wrapper for bls12-381 ([#2316](https://github.com/alessandromazza98/revm/pull/2316))
- Add a wrapper for arkworks for EIP196 ([#2305](https://github.com/alessandromazza98/revm/pull/2305))
- add bn_mul benchmark ([#2287](https://github.com/alessandromazza98/revm/pull/2287))
- Return Fatal error on bls precompiles if in no_std ([#2249](https://github.com/alessandromazza98/revm/pull/2249))
- bls special case G1/G2_MUL ([#2248](https://github.com/alessandromazza98/revm/pull/2248))
- Remove PrecompileError from PrecompileProvider ([#2233](https://github.com/alessandromazza98/revm/pull/2233))
- *(docs)* MyEvm example and book cleanup ([#2218](https://github.com/alessandromazza98/revm/pull/2218))
- remove specification crate ([#2165](https://github.com/alessandromazza98/revm/pull/2165))
- *(eip7702)* apply latest EIP-7702 changes, backport from v52 ([#1969](https://github.com/alessandromazza98/revm/pull/1969))
- integrate codspeed ([#1935](https://github.com/alessandromazza98/revm/pull/1935))
- Restucturing Part7 Handler and Context rework ([#1865](https://github.com/alessandromazza98/revm/pull/1865))
...
- c-kzg bump, cleanup on kzgsetting ([#1719](https://github.com/alessandromazza98/revm/pull/1719))
- use batch bn256 pair operation ([#1643](https://github.com/alessandromazza98/revm/pull/1643))
- use `kzg-rs` for kzg point evaluation ([#1558](https://github.com/alessandromazza98/revm/pull/1558))
- *(Precompiles)* Throw fatal error if c-kzg is disabled ([#1589](https://github.com/alessandromazza98/revm/pull/1589))
- *(precompiles)* fatal error for precompiles ([#1499](https://github.com/alessandromazza98/revm/pull/1499))
- add ecAdd to precompile bench ([#1496](https://github.com/alessandromazza98/revm/pull/1496))
- *(optimism)* Add secp256r1 precompile for Fjord ([#1436](https://github.com/alessandromazza98/revm/pull/1436))
- *(precompile)* Prague - EIP-2537 - BLS12-381 curve operations ([#1389](https://github.com/alessandromazza98/revm/pull/1389))
- *(precompile)* add Prague hardfork specification ([#1387](https://github.com/alessandromazza98/revm/pull/1387))
- add flag to force hashbrown usage ([#1284](https://github.com/alessandromazza98/revm/pull/1284))
- EOF (Ethereum Object Format) ([#1143](https://github.com/alessandromazza98/revm/pull/1143))
- make all precompiles public ([#1213](https://github.com/alessandromazza98/revm/pull/1213))
- add benchmarks for ecpairing, kzg, ecrecover precompiles ([#1211](https://github.com/alessandromazza98/revm/pull/1211))
- use Message::from_digest in secp256k1 ecrecover ([#1199](https://github.com/alessandromazza98/revm/pull/1199))
- *(precompile)* add a bool to bytes32 helper function ([#1170](https://github.com/alessandromazza98/revm/pull/1170))
- precompile with generic context ([#1155](https://github.com/alessandromazza98/revm/pull/1155))
- Add boxed precompile trait ([#1131](https://github.com/alessandromazza98/revm/pull/1131))
- bump c-kzg, add portable feature, make it default ([#1106](https://github.com/alessandromazza98/revm/pull/1106))
- *(op)* Ecotone hardfork ([#1009](https://github.com/alessandromazza98/revm/pull/1009))
- EvmBuilder and External Contexts ([#888](https://github.com/alessandromazza98/revm/pull/888))
- add asm-keccak feature ([#972](https://github.com/alessandromazza98/revm/pull/972))
- `Canyon` hardfork behind `optimism` feature flag ([#871](https://github.com/alessandromazza98/revm/pull/871))
- *(interpreter)* add more helper methods to memory ([#794](https://github.com/alessandromazza98/revm/pull/794))
- *(precompile)* use Aurora modexp lib. ([#769](https://github.com/alessandromazza98/revm/pull/769))
- derive more traits ([#745](https://github.com/alessandromazza98/revm/pull/745))
- Alloy primitives ([#724](https://github.com/alessandromazza98/revm/pull/724))
- Optimism execution changes ([#682](https://github.com/alessandromazza98/revm/pull/682))
- add "kzg" as a separate feature ([#746](https://github.com/alessandromazza98/revm/pull/746))
- implement EIP-4844 ([#668](https://github.com/alessandromazza98/revm/pull/668))
- alloy migration ([#535](https://github.com/alessandromazza98/revm/pull/535))
...
- correct propagate features ([#2177](https://github.com/alessandromazza98/revm/pull/2177))
- *(precompiles)* add portable flag for bls ([#2174](https://github.com/alessandromazza98/revm/pull/2174))
- *(blst)* Fix blst wrong constants values and usage ([#2102](https://github.com/alessandromazza98/revm/pull/2102))
- *(Inspector)* frame_end called multiple times ([#2037](https://github.com/alessandromazza98/revm/pull/2037))
- *(eof)* fixture 2 tests ([#1550](https://github.com/alessandromazza98/revm/pull/1550))
- check canonical Fp elements ([#1434](https://github.com/alessandromazza98/revm/pull/1434))
- *(precompile)* ignore infinity points in G1 MSM ([#1432](https://github.com/alessandromazza98/revm/pull/1432))
- *(precompile)* BLS G2 MSM ([#1428](https://github.com/alessandromazza98/revm/pull/1428))
- *(precompile)* blst dangling pointers, cleanup ([#1391](https://github.com/alessandromazza98/revm/pull/1391))
- *(precompile)* inherit Prague precompiles from Cancun ([#1392](https://github.com/alessandromazza98/revm/pull/1392))
- update/enable bn128 tests ([#1242](https://github.com/alessandromazza98/revm/pull/1242))
- use correct bn128 mul input length ([#1238](https://github.com/alessandromazza98/revm/pull/1238))
- use correct rand package for thread_rng ([#1233](https://github.com/alessandromazza98/revm/pull/1233))
- rename and pass optimism-default-handler to revm-primitives ([#1098](https://github.com/alessandromazza98/revm/pull/1098))
- *(ci)* Workflow Touchups ([#901](https://github.com/alessandromazza98/revm/pull/901))
- *(eip4844)* Pass eth tests, additional conditions added. ([#735](https://github.com/alessandromazza98/revm/pull/735))
- pairing cost formula  ([#659](https://github.com/alessandromazza98/revm/pull/659))
- *(doc)* Inline documentation of re-exports ([#560](https://github.com/alessandromazza98/revm/pull/560))
- k256 compile error ([#451](https://github.com/alessandromazza98/revm/pull/451))

### Other

- fixed `EIP` to `RIP` ([#2388](https://github.com/alessandromazza98/revm/pull/2388))
- *(precompile)* remove unused dependencies ([#2378](https://github.com/alessandromazza98/revm/pull/2378))
- add 0x prefix to b256! and address! calls ([#2345](https://github.com/alessandromazza98/revm/pull/2345))
- alloy 0.13 and kzg v2.1.0 ([#2342](https://github.com/alessandromazza98/revm/pull/2342))
- release-plz ([#2340](https://github.com/alessandromazza98/revm/pull/2340))
- [**breaking**] Move modulus constant into blst wrapper ([#2336](https://github.com/alessandromazza98/revm/pull/2336))
- Remove TODO for NBITS and remove NBITS from blst MSM API ([#2337](https://github.com/alessandromazza98/revm/pull/2337))
- remove no-std method for bls ([#2338](https://github.com/alessandromazza98/revm/pull/2338))
- Move all benchmarks into their own module like eip2537 ([#2335](https://github.com/alessandromazza98/revm/pull/2335))
- add bls12-381 benchmarks ([#2327](https://github.com/alessandromazza98/revm/pull/2327))
- add encode_fp function ([#2328](https://github.com/alessandromazza98/revm/pull/2328))
- clean up blst wrapper doc comment and types ([#2314](https://github.com/alessandromazza98/revm/pull/2314))
- Move all blst related methods into blst wrapper ([#2313](https://github.com/alessandromazza98/revm/pull/2313))
- Remove LATEST variant from SpecId enum ([#2299](https://github.com/alessandromazza98/revm/pull/2299))
- revm v20.0.0 stable version, tag v66 ([#2294](https://github.com/alessandromazza98/revm/pull/2294))
- *(op-precompiles)* Add missing g2 add tests ([#2253](https://github.com/alessandromazza98/revm/pull/2253))
- v65 revm: v20.0.0-alpha.7 ([#2280](https://github.com/alessandromazza98/revm/pull/2280))
- add early exit for no-ops in EIP1962 and EIP2537 ([#2271](https://github.com/alessandromazza98/revm/pull/2271))
- *(op-precompiles)* Check subset of l1 precompiles in op ([#2204](https://github.com/alessandromazza98/revm/pull/2204))
- Add `g1_mul`, `g1_add` and `read_scalar` methods into substrate wrapper for bn128 ([#2264](https://github.com/alessandromazza98/revm/pull/2264))
- *(op-precompiles)* clean up op tx tests ([#2242](https://github.com/alessandromazza98/revm/pull/2242))
- Adds a wrapper around substrate-bn for EIP196 ([#2258](https://github.com/alessandromazza98/revm/pull/2258))
- add invariant test for G1/G2 Mul ([#2247](https://github.com/alessandromazza98/revm/pull/2247))
- add documentation for the gas related constants for EIP2537 ([#2246](https://github.com/alessandromazza98/revm/pull/2246))
- add a safe blst wrapper ([#2223](https://github.com/alessandromazza98/revm/pull/2223))
- Remove redundant bls12-381 constants and cleanup naming ([#2235](https://github.com/alessandromazza98/revm/pull/2235))
- Add some documentation for the bls12-381 precompile constants ([#2222](https://github.com/alessandromazza98/revm/pull/2222))
- tag v63 revm v20.0.0-alpha.6 ([#2219](https://github.com/alessandromazza98/revm/pull/2219))
- tag v62 revm v20.0.0-alpha.5 ([#2198](https://github.com/alessandromazza98/revm/pull/2198))
- tag v61 revm v20.0.0-alpha.4 ([#2190](https://github.com/alessandromazza98/revm/pull/2190))
- *(precompile)* refactor out msm helper ([#2179](https://github.com/alessandromazza98/revm/pull/2179))
- tag v60, revm v20.0.0-alpha.3 ([#2176](https://github.com/alessandromazza98/revm/pull/2176))
- v59 release-plz update ([#2170](https://github.com/alessandromazza98/revm/pull/2170))
- simplify bn128::run_pair ([#2137](https://github.com/alessandromazza98/revm/pull/2137))
- export eip2930 eip7702 types from one place ([#2097](https://github.com/alessandromazza98/revm/pull/2097))
- PrecompileErrors to PrecompileError ([#2103](https://github.com/alessandromazza98/revm/pull/2103))
- Update broken link secp256r1.rs ([#2099](https://github.com/alessandromazza98/revm/pull/2099))
- G1_msm base gas fee const correction ([#2100](https://github.com/alessandromazza98/revm/pull/2100))
- Split blst constants out to individual file #2085
- *(deps)* bump breaking deps ([#2093](https://github.com/alessandromazza98/revm/pull/2093))
- move all dependencies to workspace ([#2092](https://github.com/alessandromazza98/revm/pull/2092))
- tag v57 revm 20.0.0-alpha.1 ([#2086](https://github.com/alessandromazza98/revm/pull/2086))
- backport op l1 fetch perf ([#2076](https://github.com/alessandromazza98/revm/pull/2076))
- Bump licence year to 2025 ([#2058](https://github.com/alessandromazza98/revm/pull/2058))
- bump kzg.rs ([#2002](https://github.com/alessandromazza98/revm/pull/2002))
- align crates versions ([#1983](https://github.com/alessandromazza98/revm/pull/1983))
- blst reprice, remove g1/g2 mul ([#1981](https://github.com/alessandromazza98/revm/pull/1981))
- integrate rust-secp256k1 ([#1915](https://github.com/alessandromazza98/revm/pull/1915))
- fix comments and docs into more sensible ([#1920](https://github.com/alessandromazza98/revm/pull/1920))
- Rename PRAGUE_EOF to OSAKA ([#1903](https://github.com/alessandromazza98/revm/pull/1903))
- *(precompile)* use secp256k1 global context for ecrecover ([#1843](https://github.com/alessandromazza98/revm/pull/1843))
- fix some typos ([#1800](https://github.com/alessandromazza98/revm/pull/1800))
- Replace `PrecompileError` variant ([#1797](https://github.com/alessandromazza98/revm/pull/1797))
- *(deps)* bump once_cell from 1.19.0 to 1.20.0 ([#1773](https://github.com/alessandromazza98/revm/pull/1773))
- make clippy happy ([#1755](https://github.com/alessandromazza98/revm/pull/1755))
- release ([#1729](https://github.com/alessandromazza98/revm/pull/1729))
- bump kzg-rs version ([#1734](https://github.com/alessandromazza98/revm/pull/1734))
- main changelog ([#1730](https://github.com/alessandromazza98/revm/pull/1730))
- release ([#1722](https://github.com/alessandromazza98/revm/pull/1722))
- bump `kzg-rs` version ([#1726](https://github.com/alessandromazza98/revm/pull/1726))
- switch gas check order in blake2 precompile ([#1718](https://github.com/alessandromazza98/revm/pull/1718))
- tag v41 revm v13.0.0 ([#1692](https://github.com/alessandromazza98/revm/pull/1692))
- release ([#1683](https://github.com/alessandromazza98/revm/pull/1683))
- Add OP-Granite hardfork, limiting bn256Pairing input size ([#1685](https://github.com/alessandromazza98/revm/pull/1685))
- *(deps)* bump rstest from 0.21.0 to 0.22.0 ([#1681](https://github.com/alessandromazza98/revm/pull/1681))
- *(deps)* bump blst from 0.3.12 to 0.3.13 ([#1669](https://github.com/alessandromazza98/revm/pull/1669))
- *(clippy)* 1.80 rust clippy list paragraph ident ([#1661](https://github.com/alessandromazza98/revm/pull/1661))
- use `is_zero` for `U256` and `B256` ([#1638](https://github.com/alessandromazza98/revm/pull/1638))
- bump versions bcs of primitives ([#1631](https://github.com/alessandromazza98/revm/pull/1631))
- release ([#1620](https://github.com/alessandromazza98/revm/pull/1620))
- main CHANGELOG ([#1592](https://github.com/alessandromazza98/revm/pull/1592))
- release ([#1579](https://github.com/alessandromazza98/revm/pull/1579))
- bump precompile to v9.0.0 ([#1590](https://github.com/alessandromazza98/revm/pull/1590))
- release ([#1548](https://github.com/alessandromazza98/revm/pull/1548))
- avoid cloning precompiles ([#1486](https://github.com/alessandromazza98/revm/pull/1486))
- *(precompiles)* Fix some nits in bls12_381 ([#1495](https://github.com/alessandromazza98/revm/pull/1495))
- *(deps)* allow multiple versions of secp256k1 ([#1490](https://github.com/alessandromazza98/revm/pull/1490))
- *(deps)* bump rstest from 0.19.0 to 0.21.0 ([#1482](https://github.com/alessandromazza98/revm/pull/1482))
- *(deps)* bump blst from 0.3.11 to 0.3.12 ([#1481](https://github.com/alessandromazza98/revm/pull/1481))
- add test for map_fp_to_g1 precompile ([#1465](https://github.com/alessandromazza98/revm/pull/1465))
- add docs for BLS scalar input decoding ([#1446](https://github.com/alessandromazza98/revm/pull/1446))
- release ([#1261](https://github.com/alessandromazza98/revm/pull/1261))
- bump c-kzg to 1.0.2 ([#1390](https://github.com/alessandromazza98/revm/pull/1390))
- refactor lints ([#1386](https://github.com/alessandromazza98/revm/pull/1386))
- *(deps)* bump aurora-engine-modexp from 1.0.0 to 1.1.0 ([#1339](https://github.com/alessandromazza98/revm/pull/1339))
- *(deps)* bump secp256k1 from 0.28.2 to 0.29.0 ([#1260](https://github.com/alessandromazza98/revm/pull/1260))
- release ([#1231](https://github.com/alessandromazza98/revm/pull/1231))
- remove unnecessary call to into_u256() for bn128 add ([#1239](https://github.com/alessandromazza98/revm/pull/1239))
- Revert "feat: optional nonce check ([#1195](https://github.com/alessandromazza98/revm/pull/1195))" ([#1212](https://github.com/alessandromazza98/revm/pull/1212))
- release ([#1175](https://github.com/alessandromazza98/revm/pull/1175))
- expose functionality for custom EVMs ([#1201](https://github.com/alessandromazza98/revm/pull/1201))
- c-kzg v1.0.0 ([#1190](https://github.com/alessandromazza98/revm/pull/1190))
- fix some typos ([#1189](https://github.com/alessandromazza98/revm/pull/1189))
...
- *(precompile)* use `Bytes` in precompile functions ([#1085](https://github.com/alessandromazza98/revm/pull/1085))
...
- *(precompile)* don't allocate if padding is not needed ([#1075](https://github.com/alessandromazza98/revm/pull/1075))
- *(precompile)* simplify bn128 precompile implementations ([#1074](https://github.com/alessandromazza98/revm/pull/1074))
- *(precompile)* make use of padding utilities, simplify secp256k1 ([#1073](https://github.com/alessandromazza98/revm/pull/1073))
- precompile bn128 copy ([#1071](https://github.com/alessandromazza98/revm/pull/1071))
- *(revm)* Add helpers to Build Revm with Context ([#1068](https://github.com/alessandromazza98/revm/pull/1068))
- tag v27, revm v4.0.0 release ([#1061](https://github.com/alessandromazza98/revm/pull/1061))
- bump c-kzg and enable blst portable feature ([#1059](https://github.com/alessandromazza98/revm/pull/1059))
- *(deps)* bump secp256k1 from 0.28.1 to 0.28.2 ([#1038](https://github.com/alessandromazza98/revm/pull/1038))
- *(Cancun)* update Cancun precompiles docs ([#1015](https://github.com/alessandromazza98/revm/pull/1015))
- *(log)* use alloy_primitives::Log ([#975](https://github.com/alessandromazza98/revm/pull/975))
- *(deps)* bump k256 from 0.13.2 to 0.13.3 ([#959](https://github.com/alessandromazza98/revm/pull/959))
- *(deps)* bump secp256k1 from 0.28.0 to 0.28.1 ([#954](https://github.com/alessandromazza98/revm/pull/954))
- *(deps)* bump once_cell from 1.18.0 to 1.19.0 ([#908](https://github.com/alessandromazza98/revm/pull/908))
- bump k256 and use normalize_s ([#870](https://github.com/alessandromazza98/revm/pull/870))
- simplify use statements ([#864](https://github.com/alessandromazza98/revm/pull/864))
- *(precompiles)* Make PrecompileWithAddress field public, from impl ([#857](https://github.com/alessandromazza98/revm/pull/857))
- change addresses to iterator and add into_addresses ([#855](https://github.com/alessandromazza98/revm/pull/855))
- bump c-kzg to v0.4.0 ([#849](https://github.com/alessandromazza98/revm/pull/849))
- Refactor precompile list from Hash to vec ([#823](https://github.com/alessandromazza98/revm/pull/823))
- *(eip4844)* update kzg trusted setup ([#822](https://github.com/alessandromazza98/revm/pull/822))
- secp256k1 from 0.27 to 0.28 ([#817](https://github.com/alessandromazza98/revm/pull/817))
- for now support 1.69 rust compiler ([#814](https://github.com/alessandromazza98/revm/pull/814))
- document everything, dedup existing docs ([#741](https://github.com/alessandromazza98/revm/pull/741))
- bump v26 revm v3.5.0 ([#765](https://github.com/alessandromazza98/revm/pull/765))
- tag v25, revm v3.4.0 ([#755](https://github.com/alessandromazza98/revm/pull/755))
- bump c-kzg to create lib ([#758](https://github.com/alessandromazza98/revm/pull/758))
- *(deps)* bump sha2 from 0.10.7 to 0.10.8 ([#752](https://github.com/alessandromazza98/revm/pull/752))
- modexp gas check ([#737](https://github.com/alessandromazza98/revm/pull/737))
- Removed the last dependencies breaking no-std build. ([#669](https://github.com/alessandromazza98/revm/pull/669))
- Revert "feat: alloy migration ([#535](https://github.com/alessandromazza98/revm/pull/535))" ([#616](https://github.com/alessandromazza98/revm/pull/616))
- spell check ([#615](https://github.com/alessandromazza98/revm/pull/615))
- avoid unnecessary allocations ([#581](https://github.com/alessandromazza98/revm/pull/581))
...
- *(deps)* bump sha3 from 0.10.6 to 0.10.7 ([#454](https://github.com/alessandromazza98/revm/pull/454))
- v21, revm v3.1.0 ([#444](https://github.com/alessandromazza98/revm/pull/444))
- bump all
- *(deps)* bump secp256k1 from 0.26.0 to 0.27.0 ([#429](https://github.com/alessandromazza98/revm/pull/429))
- add primitive SpecId to precompile SpecId conversion ([#408](https://github.com/alessandromazza98/revm/pull/408))
