...
## [13.1.0](https://github.com/alessandromazza98/revm/compare/revm-context-interface-v13.0.0...revm-context-interface-v13.1.0) - 2025-11-12

### Added

- *(context)* add mark_cold method to JournaledAccount ([#3160](https://github.com/alessandromazza98/revm/pull/3160))
