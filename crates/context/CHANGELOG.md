...
## [2.0.1](https://github.com/alessandromazza98/revm/compare/revm-context-v2.0.0...revm-context-v2.0.1) - 2025-04-09

### Fixed

- Effective gas price should check tx type ([#2375](https://github.com/alessandromazza98/revm/pull/2375))

### Other

- make blob params u64 ([#2385](https://github.com/alessandromazza98/revm/pull/2385))
- set gas_priority_fee to None in TxEnv ([#2371](https://github.com/alessandromazza98/revm/pull/2371))
