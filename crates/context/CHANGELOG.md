...
## [12.2.0](https://github.com/alessandromazza98/revm/compare/revm-context-v12.1.0...revm-context-v12.2.0) - 2025-12-29
...
- set transaction_id on new account ([#3204](https://github.com/alessandromazza98/revm/pull/3204))

### Other

- *(cleanup)* remove unused duplicate ContextSetters trait in context crate ([#3225](https://github.com/alessandromazza98/revm/pull/3225))
