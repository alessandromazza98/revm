...
## [14.2.0](https://github.com/alessandromazza98/revm/compare/revm-inspector-v14.1.0...revm-inspector-v14.2.0) - 2025-12-29
...
- replace HashMap with fixed-size array for opcode counts in CountInspector ([#3203](https://github.com/alessandromazza98/revm/pull/3203))
