...
## [7.0.5](https://github.com/alessandromazza98/revm/compare/revm-database-v7.0.4...revm-database-v7.0.5) - 2025-08-20

### Other

- *(database)* remove unused dependencies ([#2885](https://github.com/alessandromazza98/revm/pull/2885))
- add AccountStatus unit test ([#2869](https://github.com/alessandromazza98/revm/pull/2869))
