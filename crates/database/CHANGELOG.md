...
## [2.0.1](https://github.com/alessandromazza98/revm/compare/revm-database-v2.0.0...revm-database-v2.0.1) - 2025-04-09
...
- *(database)* remove auto_impl dependency ([#2344](https://github.com/alessandromazza98/revm/pull/2344))
