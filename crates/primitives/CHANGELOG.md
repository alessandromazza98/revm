...
## [5.0.0](https://github.com/alessandromazza98/revm/compare/revm-primitives-v4.0.0...revm-primitives-v5.0.0) - 2024-06-10
...
### Fixed
- *(primitives)* specify the optimism cfg on spec_to_generic ([#1412](https://github.com/alessandromazza98/revm/pull/1412))

### Other
- derive PartialEq and Hash on EnvKzgSettings ([#1494](https://github.com/alessandromazza98/revm/pull/1494))
