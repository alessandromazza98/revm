...
## [6.0.0](https://github.com/alessandromazza98/revm/compare/revm-primitives-v5.0.0...revm-primitives-v6.0.0) - 2024-07-03

### Added
- *(Prague)* Add EIP-7702 ([#1565](https://github.com/alessandromazza98/revm/pull/1565))
- add helper function to mape EVMError's Database error variant ([#1567](https://github.com/alessandromazza98/revm/pull/1567))

### Other
- add utility function AccountInfo::from_bytecode ([#1577](https://github.com/alessandromazza98/revm/pull/1577))
