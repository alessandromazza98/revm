...
## [15.0.0](https://github.com/alessandromazza98/revm/compare/revm-handler-v14.1.0...revm-handler-v15.0.0) - 2025-12-29

### Added

- Gas params ([#3132](https://github.com/alessandromazza98/revm/pull/3132))
- *(create)* Implement Cache for CreateInputs::created_address ([#3218](https://github.com/alessandromazza98/revm/pull/3218))
- JournaledAccount sload/sstore ([#3201](https://github.com/alessandromazza98/revm/pull/3201))
- Restrict Database::Error. JournaledAccountTr ([#3199](https://github.com/alessandromazza98/revm/pull/3199))

### Fixed

- *(create)* Fix CreateInputs::created_address Cache invalidation ([#3222](https://github.com/alessandromazza98/revm/pull/3222))

### Other

- description of `Handler::validate_against_state_and_deduct_caller` should match responsibilities ([#3256](https://github.com/alessandromazza98/revm/pull/3256))
- *(handler)* eliminate code duplication in transaction validation ([#3243](https://github.com/alessandromazza98/revm/pull/3243))
- *(handler)* validate_initial_tx_gas takes &mut Evm  ([#3235](https://github.com/alessandromazza98/revm/pull/3235))
- *(clippy)* remove unused imports ([#3227](https://github.com/alessandromazza98/revm/pull/3227))
- optimize vector initialization using size hints ([#3200](https://github.com/alessandromazza98/revm/pull/3200))
- apply_auth_list helper fn ([#3187](https://github.com/alessandromazza98/revm/pull/3187))
