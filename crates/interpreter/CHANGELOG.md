...
## [7.0.0](https://github.com/alessandromazza98/revm/compare/revm-interpreter-v6.0.0...revm-interpreter-v7.0.0) - 2024-07-03
...
- support selfdestruct for dummyhost ([#1578](https://github.com/alessandromazza98/revm/pull/1578))
...
### Fixed
- *(eof)* ExtDelegateCall caller/target switch ([#1571](https://github.com/alessandromazza98/revm/pull/1571))
